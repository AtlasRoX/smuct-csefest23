    ...
    return (
      <div className="flex flex-col space-y-1.5 w-full">
        ...
        <input
          ...
          className={twMerge(
            clsx(
              "flex h-10 w-full rounded-radius-sm border bg-neutral-950 px-3 py-2 text-sm text-neutral-50 placeholder:text-neutral-600 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium font-sans",
              {
