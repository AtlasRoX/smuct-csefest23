...
export function Badge({ className, variant = "neutral", ...props }: BadgeProps) {
  return (
    <span
      className={twMerge(
        clsx(
          "inline-flex items-center rounded-radius-full px-2.5 py-0.5 text-xs font-semibold font-sans tracking-wide select-none border border-transparent transition-colors",
          {
